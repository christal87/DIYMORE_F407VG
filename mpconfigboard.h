#define MICROPY_HW_BOARD_NAME       "DIYMORE STM32F407VG"
#define MICROPY_HW_MCU_NAME         "STM32F407VG"
#define MICROPY_HW_FLASH_FS_LABEL   "F407VG"

// 1 = use internal flash (1 MByte)
// 0 = use externally added flash
#define MICROPY_HW_ENABLE_INTERNAL_FLASH_STORAGE (1)

#define MICROPY_HW_HAS_SWITCH       (1)		// has one user button K1
#define MICROPY_HW_HAS_FLASH        (1)
#define MICROPY_HW_ENABLE_RNG       (1)
#define MICROPY_HW_ENABLE_RTC       (1)
#define MICROPY_HW_ENABLE_DAC       (1)
#define MICROPY_HW_ENABLE_USB       (1)
#define MICROPY_HW_ENABLE_SDCARD    (0)		// it has no SD card socket on-board
...
// K2 has pullup; Pressing the button makes the input go low.
...
// LEDs
// LED1 is the power LED and always on
#define MICROPY_HW_LED1             (pin_E0)  // LED2
#define MICROPY_HW_LED_ON(pin)      (mp_hal_pin_low(pin))
#define MICROPY_HW_LED_OFF(pin)     (mp_hal_pin_high(pin))

// If using externally added flash
/*
...
#define MICROPY_BOARD_EARLY_INIT    Diymore_F407VG_board_early_init
